...
from plugin_root import PLUGIN_ROOT, LIB_DIR, INVENTORY_DIR, SKILLS_DIR, vaws_local_dir

for _p in (str(LIB_DIR), str(INVENTORY_DIR)):
...
MEMPROF_STATE_DIR = vaws_local_dir() / "memory-profiling"
SERVING_STATE_DIR = vaws_local_dir() / "serving"
...
def resolve_execution_target(
    ...
    *,
    ...
    return {
        ...
        "session_file": None,
        "session": None,
        "state_repo_root": vaws_local_dir().parent,
    }
